...
<body>
		...
		<div class=" admin-content">
			...
			<div class="admin-biaogelist">
				<div class="listbiaoti am-cf">
					<ul class="am-icon-flag on"> 待发货订单列表 </ul>
					<dl class="am-icon-home" style="float: right;"> 当前位置： 首页 > 待发货订单列表 </dl>
				</div>
	...
	<!--<![endif]-->
	<script src="/resources/js/admin/order/waitsendlist.js?0728"></script>
</body>
</html>