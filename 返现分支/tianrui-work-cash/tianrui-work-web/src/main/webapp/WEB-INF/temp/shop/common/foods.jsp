...
<ul class="quanbu-ul1" style="z-index:999">
    	<li class="foods_01" style="width: 33.33%">
        	<div class="qu-tu1">
    	...
    	<!-- 
    	<li class="foods_02" style="width: 20%">
        	<div class="qu-tu1">
            	<a href="/wechat/shop/goods/goodshome?goodsType=2" class="atu1"><img src="${staticRoot}/shop/images/sjsc-16.png"></a>
            	<a href="/wechat/shop/goods/goodshome?goodsType=2" class="atu2"><img src="${staticRoot}/shop/images/sjsc-16-1.png"></a>
            </div>
            <a href="/wechat/shop/goods/goodshome?goodsType=2" class="qu-ul1a">宏包商城</a>
        </li>
    	 -->
    	<!-- 
    	<li class="foods_04" style="width: 20%">
        	<div class="qu-tu1">
            	<a href="/wechat/shop/creditor/selectPage" class="atu1"><img src="${staticRoot}/shop/images/sjsc23-11.gif"></a>
            	<a href="/wechat/shop/creditor/selectPage" class="atu2"><img src="${staticRoot}/shop/images/sjsc23-11.gif"></a>
            </div>
            <a href="/wechat/shop/creditor/selectPage" class="qu-ul1a">债权发布</a>
        </li>
    	 -->
    	
    	<li class="foods_03" style="width: 33.33%">
        	<div class="qu-tu1">
    	...
    	<li class="foods_05" style="width: 33.33%">
        	<div class="qu-tu1">
